...
- DPD: ~~w przepływie (na strzałkach) powinny być tylko dane (a nie procesy np. aktualizacja), na strzałce tylko 1 typ danych (bez slasha - rozbić na dwie strzałki), w lewym górnym rogu zrobić notatkę jaki to diagram, usunąć "czarne dziury" - procesy bez wyjścia, może dopisać poziomy aby były same działania proste?, czy API Google Maps powinien się tam znaleźć?~~
...
[25.01.2026 -- Maciek] Dodałem diag. maszyny stanowej i poprawiłem pozostałe - teraz tylko zostaje diagram aktywności (chyba? teraz nie wiem) i textual analysis (mogę w tym pomóc - daj znać)
